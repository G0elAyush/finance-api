...
public class SwaggerDocumentationConfig {
	...
	OpenAPI openApi() {
		return new OpenAPI()
				.info(new Info()
				.title("Swagger ToDo Application - OpenAPI 3.0")
				.description("This is a ToDo Application Server based on the OpenAPI 3.0 specification. "
				...
				.termsOfService("").version("1.0.1")
				.license(new License().name("Apache 2.0").url("http://www.apache.org/licenses/LICENSE-2.0.html"))
				.contact(new io.swagger.v3.oas.models.info.Contact().email("mwayush@gmail.com")));
	}
